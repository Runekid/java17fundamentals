# Vaadin 14+ Component and Element API training

This is the training material for the Vaadin 14+ Component and Element API training. It's a multi-module maven project which contains 2 sub modules: exercises and solutions.
