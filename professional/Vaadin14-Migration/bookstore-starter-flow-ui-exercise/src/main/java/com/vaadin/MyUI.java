...
public class MyUI extends UI {
    ...
    public static class MyUIServlet extends VaadinServlet {
        @Override
        protected DeploymentConfiguration createDeploymentConfiguration(Properties initProperties){
            initProperties.setProperty(Constants.PARAMETER_VAADIN_RESOURCES,"/framework");
            return super.createDeploymentConfiguration(initProperties);
        }
    }
}
